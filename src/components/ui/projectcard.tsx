            ...
            > */}
              <div
                ...
                <div className='w-auto h-auto flex flex-row gap-2'>
                  <div className='absolute w-screen h-full top-0 left-[50%] translate-x-[-50%] pointer-events-none z-50 flex flex-row items-center justify-between'>
                    <div className='w-full h-full pointer-events-none bg-gradient-to-r from-20% from-header-bg to-30% to-transparent' />
                    <div className='w-full h-full pointer-events-none bg-gradient-to-l from-20% from-header-bg to-30% to-transparent' />
                  </div>
                  {images.length > 1 && (
              ...
              {/* </div> */}
              <span
                className='flex items-center justify-center gap-0.5 p-2 cursor-pointer rounded-full hover:bg-[#8b8b8b30] transition-all'
